...
const testimonials = [
    {
        ...
        text: "Schedura has saved our team 10+ hours a week. The AI composer is genuinely impressive — it writes content that sounds like us.",
    },
    {
        name: "Marcus L.",
        role: "Indie Creator",
    ...
    },
    {
        ...
        text: "Finally a Schedura that's beautiful AND powerful. The clean dashboard makes it easy to see exactly what's going out and when.",
    },
];
        ...
        <section className="py-24 bg-slate-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-14">
                    ...
                    <p className="mt-5 text-gray-500 max-w-md mx-auto">Join thousands of people who automate their social media with Schedura.</p>
                </div>
