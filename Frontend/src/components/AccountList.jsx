  ...
  if(accounts.length === 0){
    return (
      <div className='bg-white rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center py-20 px-6'>
        ...
        <p className='text-sm text-slate-400 mt-1 max-w-xs text-center'>Connect your first social platform to start scheduling and automate your content</p>
      </div>
    )
  }
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
      {accounts.map((account,idx)=>{
        ...
        return (
          <div
            key={idx}
            className="group bg-white border border-slate-200 rounded-2xl p-5 flex items-center gap-4 hover:border-slate-300 transition-all justify-around"
          >
            ...
            <div className="flex flex-col items-center justify-center">
              <button
                ...
                className="ml-2 p-1.5 rounded-lg text-slate-300 group-hover:text-red-400 transition-all"
              >
